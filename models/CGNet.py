...
class UpsampleWithFlops(nn.Upsample):
    ...
    @property
    def total_ops(self):
        return torch.tensor(self.__flops__)
...
if __name__ == '__main__':
    ...
    model = CGNet(img_channel=4,width=60, middle_blk_num=10,
                    enc_blk_nums=[2, 2, 4, 6], dec_blk_nums=[2, 2, 2, 2],GCE_CONVS_nums=[3,3,2,2]).cuda()
